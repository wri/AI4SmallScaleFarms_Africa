...
This repo will be used for field boundary delineation, crop mapping and yield prediction work in Africa.

---

## Step 1: Obtaining Areas of Interest (Nakuru and Nyandarua counties)

A crucial first step in field boundary delineation and crop mapping is to obtain the counties of interest. This project provides tools to download Kenya county shapefiles and extract specific counties (Nakuru and Nyandarua) with their subcounties.
